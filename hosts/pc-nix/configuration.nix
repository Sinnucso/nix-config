...
#  plasma.enable = true;
  ...
  networking.hostName = "pc-nix"; # Define your hostname.
...
## nvidia graphics card driver (https://nixos.wiki/wiki/Nvidia)
  # Enable OpenGL
...
#    users = {"sinnucso" = import ./home.nix;};
#  };
